...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full lg:w-1/2 p-8 space-y-8">
          ...
          <form className="mt-8 space-y-12" onSubmit={handleSubmit}>
            <div className="space-y-8">
              <div>
                ...
                <input
                  ...
                  shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 
              ...
              <div>
                ...
                />
                {errorDisplay && (
                  <p className="p-0 m-0 flex justify-center text-red-600">
                    {errorMessage}
                  </p>
                )}
              </div>
            ...
            <div>
              <button
                ...
                py-3 px-4 border border-transparent text-sm font-semibold 
                rounded-xl text-white bg-blue-500 focus:outline-none focus:ring-2
                 focus:ring-offset-2 focus:ring-teal-500 transform transition-all 
                 duration-150 hover:scale-[1.02]"
              >
                Start Your Journey
              </button>
              <button className="group relative pt-2 w-full flex justify-center text-sm font-semibold
               text-blue-500 hover:scale-[1.02]" onClick={HandleForgetPassword}>
                Forget Password
              </button>
            </div>
          </form>
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link
                to="/signup"
                className="font-medium text-teal-600 mb-24 hover:text-teal-500 transition-colors"
              >
                Create your account
              </Link>
            </p>
      ...
      {forgetModal && <ForgetPasswordModal setForgetModal={setForgetModal}/>}
    </div>
  );
}
