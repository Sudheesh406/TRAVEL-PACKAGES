...
const Navbar = () => {
  ...
  let isExist = useSelector((state) => state.user.user);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* <a href="#gallery" className="text-gray-700 hover:text-blue-600 px-3 py-2 font-medium">Gallery</a> */}
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a href="#gallery" className="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium">Gallery</a>
